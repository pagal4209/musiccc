...
from Sifra.utils import first_page, second_page
from Sifra.utils.database import get_lang
from Sifra.utils.decorators.language import LanguageStart, languageCB
from Sifra.utils.inline.help import help_back_markup, private_help_panel
...
@app.on_callback_query(filters.regex("AyanoXaditi") & ~BANNED_USERS)
@languageCB
...
@app.on_callback_query(filters.regex("Anya") & ~BANNED_USERS)
@languageCB
